<%-- 
    Document   : Cart
    Created on : 29-nov-2017, 16:57:37
    Author     : Paul
--%>
...
<%@page import="Datos.DetalleVenta"%>
    ...
    <div class="grid">
        ...
        <h1 class="h2 title text-center">Tu carrito</h1>
            ...
            <!---------------------------la shitttttttt------------------------------------------------------------------------------->
                    ...
                    <p class="h3--body"><a href="/products/black-shirt" title="" > <%= d.getProducto().getNombre()%> .</a></p>

                    <h6 itemprop="price">
                        <span class="money"><%= d.getProducto().getDescripcion()%></span>
                        <span class="money">Precio: $<%= d.getProducto().getPrecio()%></span>
                    </h6>
                    <h6 itemprop="price">
                        <span class="money">Cantidad: $<%= d.getProducto().getCantidad()%>
                                            <%%></span>
                    </h6>

                    <p> Total: $<%= (d.getProducto().getPrecio() * d.getProducto().getCantidad())%></p>
